    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="visit_date" placeholder="" value="@if (session('date')) {{ session('date') }} @endif" >
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="time" class="form-control" name="arrive_time" placeholder="" value="@if (session('arr')) {{ session('arr') }} @endif">
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="time" class="form-control" name="depart_time" placeholder="" value="@if (session('dep')) {{ session('dep') }} @endif">
        ...
        <div class="row">
            <div class="col-md-7 mb-3">
                ...
                <input type="text" class="form-control" name="contact" placeholder="" value="@if (session('contact')) {{ session('contact') }} @endif" >
                <div class="invalid-feedback">
            ...
            <div class="col-md-5 mb-3">
                <label>Phone #</label>
                <input type="text" class="form-control" name="phone" placeholder="" value="@if (session('phone')) {{ session('phone') }} @endif">
                <div class="invalid-feedback">
