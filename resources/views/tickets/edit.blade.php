        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                <div class="custom-control custom-checkbox">
                    ...
                    {{ Form::checkbox('sign60', '1', $ticket->sign60, ['class' => 'custom-control-input', 'id' => 'sign60']) }}
            ...
            <div class="col-md-4 mb-3">
                <div class="custom-control custom-checkbox">
                    ...
                    {{ Form::checkbox('batt_charge', '1', $ticket->batt_charge, ['class' => 'custom-control-input', 'id' => 'batt_charge']) }}
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="custom-control custom-checkbox mb-3">
                    ...
                    {{ Form::checkbox('dvm', '1', $ticket->dvm, ['class' => 'custom-control-input', 'id' => 'dvm']) }}
            ...
            <div class="col">
                <div class="custom-control custom-checkbox mb-3">
                    ...
                    {{ Form::checkbox('wire_tight', '1', $ticket->wire_tight, ['class' => 'custom-control-input', 'id' => 'wire_tight']) }}
            ...
            <div class="col">
                <div class="custom-control custom-checkbox mb-3">
                    ...
                    {{ Form::checkbox('wire_hot', '1', $ticket->wire_hot, ['class' => 'custom-control-input', 'id' => 'wire_hot']) }}
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                <div class="custom-control custom-checkbox">
                    ...
                    {{ Form::checkbox('armed_arr', '1', $ticket->armed_arr, ['class' => 'custom-control-input', 'id' => 'armed_arr']) }}
            ...
            <div class="col-md-4">
                <div class="custom-control custom-checkbox">
                    ...
                    {{ Form::checkbox('armed_dep', '1', $ticket->armed_dep, ['class' => 'custom-control-input', 'id' => 'armed_dep']) }}
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                <div class="custom-control custom-checkbox">
                    ...
                    {{ Form::checkbox('fence_arr', '1', $ticket->fence_arr, ['class' => 'custom-control-input', 'id' => 'fence_arr']) }}
            ...
            <div class="col-md-4">
                <div class="custom-control custom-checkbox">
                    ...
                    {{ Form::checkbox('fence_dep', '1', $ticket->fence_dep, ['class' => 'custom-control-input', 'id' => 'fence_dep']) }}
