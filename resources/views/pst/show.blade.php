    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <input type="text" class="form-control" name="ticket_num" placeholder="" value="{{ $pst->ticket_num }}" >
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="acct_num" placeholder="" value="{{ $pst->acct_num}}" >
                    <div class="invalid-feedback">
                        Account # is required.
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="tech" placeholder="" value="{{ $pst->tech }}">
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="installer" placeholder="" value="{{ $pst->installer }}">
                    <div class="invalid-feedback"></div>
                </div>

                <div class="mb-3">
                    <label for="visit_date">Date</label>
                    <input type="date" class="form-control" name="date" placeholder="" value="{{ $pst->date }}" >
                    <div class="invalid-feedback">
        ...
        <div class="row">
            <div class="col-md-7 mb-3">
                ...
                <input type="text" class="form-control" name="cust_name" placeholder="" value="{{ $pst->cust_name }}" >
                <div class="invalid-feedback">
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control" name="city" placeholder="" value="{{ $pst->city }}">
                <div class="invalid-feedback">
            ...
            <div class="col-md-2 mb-3">
                ...
                <input type="text" class="form-control" name="state" placeholder="" value="{{ $pst->state }}">
                <div class="invalid-feedback">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                {{ Form::select('check_type', $sys_options, $pst->check_type, ['class'=> 'form-control mb-3 custom-select']) }}    
            </div>
        ...
        <textarea class="form-control" id="quest1" name="quest1" rows="3">{{ $pst->quest1 }}</textarea>
            <div class="invalid-feedback"></div>
        </div>

        <div class="mb-4">
            <label>Customer comments about install/add on process:</label>
            <textarea class="form-control" id="quest2" name="quest2" rows="3">{{ $pst->quest2 }}</textarea>
            <div class="invalid-feedback"></div>
        </div>

        <div class="mb-4">
            <label>Was customer well versed on the system operation and troubleshooting?</label>
            <textarea class="form-control" id="quest3" name="quest3" rows="3">{{ $pst->quest3 }}</textarea>
            <div class="invalid-feedback"></div>
        </div>

        <div class="mb-4">
            <label>Look over tech layout and install/add-on layout and list for differences:</label>
            <textarea class="form-control" id="quest4" name="quest4" rows="3">{{ $pst->quest4 }}</textarea>
            <div class="invalid-feedback"></div>
        </div>

        <div class="mb-4">
            <label>Was there any work needed to be complete install/add-on? Please list:</label>
            <textarea class="form-control" id="quest5" name="quest5" rows="3">{{ $pst->quest5 }}</textarea>
            <div class="invalid-feedback"></div>
        </div>

        <div class="mb-4">
            <label>List any security concerns and how they were fixed:</label>
            <textarea class="form-control" id="quest6" name="quest6" rows="3">{{ $pst->quest6 }}</textarea>
            <div class="invalid-feedback"></div>
        </div>

        <div class="mb-4">
            <label>List any cosmetic concerns and how they were fixed:</label>
            <textarea class="form-control" id="quest7" name="quest7" rows="3">{{ $pst->quest7 }}</textarea>
            <div class="invalid-feedback"></div>
        </div>

        <div class="mb-4">
            <label>Comments:</label>
            <textarea class="form-control" id="quest8" name="quest8" rows="3">{{ $pst->quest8 }}</textarea>
            <div class="invalid-feedback"></div>
        </div>
